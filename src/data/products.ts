...
export const products: Product[] = [
  ...
  {
    id: "16",
    name: "AX Home Hikvision WiFi",
    slug: "ax-home-hikvision-wifi",
    category: "seguridad",
    description:
      "Panel de control de alarma inalambrica Hikvision con WiFi, app movil y hasta 16 zonas para proteger tu hogar",
    price: 520000,
    ...
    features: [
      ...
      "Hasta 16 zonas inalambricas y alcance de 1200 m",
      "Notificaciones de alarma y eventos en la app",
      "Bateria de respaldo hasta 12 horas",
      "Compatible con sensores y perifericos AX Home",
    ],
  },
  {
    id: "17",
    name: "Videoportero Ezviz HP7",
    slug: "videoportero-ezviz-hp7",
    category: "seguridad",
    description:
      "Videoportero inteligente 2K con pantalla tactil de 7\", desbloqueo remoto y deteccion de personas desde la app EZVIZ",
    price: 980000,
    ...
    features: [
      ...
      "Pantalla interior tactil de 7 pulgadas",
      "Desbloqueo remoto de puerta y porton desde app",
      "Deteccion inteligente de personas y audio bidireccional",
      "WiFi dual banda 2.4/5 GHz y almacenamiento SD o nube",
    ],
  },
  {
    id: "18",
    name: "Videoportero Ezviz HP7 Pro 4K",
    slug: "videoportero-ezviz-hp7-pro-4k",
    category: "seguridad",
    description:
    ...
    features: [
      ...
      "Apertura por palma, rostro, RFID, codigo y app",
      "Pantalla tactil interior de 8 pulgadas",
      "Wi-Fi 6, audio bidireccional y cambio de voz",
      "Hub central compatible con cerraduras y camaras EZVIZ",
    ],
  },
];
